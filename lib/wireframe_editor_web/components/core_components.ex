defmodule WireframeEditorWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(WireframeEditorWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(WireframeEditorWeb.Gettext, "errors", msg, opts)
    end
  end
      ...
      <div class="max-w-7xl mx-auto px-4">
        <div class="flex items-center justify-between h-14">
          ...
          <div class="flex items-center gap-4">
            <a
              href="https://github.com/gbelinsky/koalemos"
              target="_blank"
