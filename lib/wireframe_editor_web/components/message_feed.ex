defmodule WireframeEditorWeb.MessageFeed do
  @moduledoc """
  ...
  ```heex
  <.live_component
    module={WireframeEditorWeb.MessageFeed}
    id="message-feed"
    messages={@messages}
  />
  ```
  ...
  alias WireframeEditorWeb.MessageCards.Helpers
  ...
  alias WireframeEditorWeb.MessageCards.ThinkingCard
